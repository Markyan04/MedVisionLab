...
def main():
    ...
    criterion = DistanceAwareSoftTargetLoss(num_classes=NUM_CLASSES, tau=DAST_TAU, gamma=DAST_GAMMA).to(device)
    ...
    best_path = resolve_checkpoint_path("best_resnet50_mecs_layer3_dast_knee_oa_new.pt")
